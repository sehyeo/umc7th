...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -843743224L;
    ...
    public final umc.workbook7th.domain.QMember member;

    public final umc.workbook7th.domain.QMission mission;

    public final EnumPath<umc.workbook7th.domain.enums.MissionStatus> status = createEnum("status", umc.workbook7th.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new umc.workbook7th.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new umc.workbook7th.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
